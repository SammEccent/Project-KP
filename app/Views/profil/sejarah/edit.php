    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3">Edit Sejarah Kelurahan</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="/profil/sejarah/edit/<?= $sejarah['id'] ?>" method="POST" class="needs-validation" novalidate>
                        <div class="mb-3">
                            <label for="tahun" class="form-label">Tahun</label>
                            <input type="text" class="form-control" id="tahun" name="tahun" 
                                   pattern="[0-9]{4}" maxlength="4" required
                                   value="<?= htmlspecialchars($sejarah['tahun']) ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="judul" name="judul" 
                                   ...
                                   value="<?= htmlspecialchars($sejarah['judul']) ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="deskripsi" name="deskripsi" 
                                      rows="5" required
                                      placeholder="Jelaskan peristiwa sejarah yang terjadi..."><?= htmlspecialchars($sejarah['deskripsi']) ?></textarea>
                            <div class="invalid-feedback">
