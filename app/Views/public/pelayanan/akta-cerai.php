...
<div class="pelayanan-hero pelayanan-hero-aktacerai position-relative">
    ...
    <div class="container text-center">
        <div class="hero-illustration mb-3 mx-auto" style="max-width:160px;">
            <!-- SVG Ilustrasi Akta Cerai -->
            <svg width="100%" height="auto" viewBox="0 0 110 80" fill="none" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
                <rect x="5" y="10" width="100" height="60" rx="8" fill="#ffebee" stroke="#f44336" stroke-width="2"/>
                <rect x="15" y="20" width="30" height="40" rx="5" fill="#ffcdd2"/>
                <rect x="50" y="25" width="45" height="8" rx="2" fill="#ffebee"/>
                <rect x="50" y="38" width="35" height="6" rx="2" fill="#ffebee"/>
                <rect x="50" y="50" width="25" height="6" rx="2" fill="#ffebee"/>
                <circle cx="30" cy="40" r="8" fill="#fff" stroke="#f44336" stroke-width="2"/>
                <circle cx="30" cy="40" r="5" fill="#f44336"/>
                <!-- Elemen simbolis -->
                <path d="M65 30 L75 40 M75 30 L65 40" stroke="#f44336" stroke-width="2"/>
                <rect x="63" y="28" width="14" height="14" rx="2" fill="none" stroke="#f44336" stroke-width="1"/>
            </svg>
        </div>
        <h1 class="pelayanan-title mb-2">Pembuatan Akta Perceraian
            <span class="bubble-tip" tabindex="0" data-tip="Akta Perceraian adalah bukti sah pencatatan perceraian yang diterbitkan oleh Dinas Kependudukan.">
            ...
            <div class="pelayanan-card shadow-sm h-100">
                <div class="pelayanan-card-header">
                    ...
                    <h2 class="pelayanan-section-title">Persyaratan
                        <span class="bubble-tip" tabindex="0" data-tip="Persyaratan adalah dokumen yang harus dipenuhi untuk mengurus Akta Perceraian.">
                ...
                <div class="pelayanan-card-body">
                    <div class="alert alert-info mb-2">
                        ...
                        <ol class="mb-0 ps-3">
                            ...
                            <li>Surat Cerai dari Pengadilan Agama/Pengadilan Negeri</li>
            ...
            <div class="pelayanan-card shadow-sm h-100">
                ...
                <div class="pelayanan-card-body">
                    <div class="alert alert-warning mb-0">
                        ...
                        <ul class="mb-0 ps-3">
                            <li>Akta Perceraian harus dibuat dalam waktu 30 hari setelah putusan pengadilan</li>
                            <li>Proses pembuatan Akta Perceraian membutuhkan waktu 1-3 hari kerja</li>
                            <li>Biaya pembuatan Akta Perceraian berbayar sesuai ketentuan</li>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq1">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse1">
                                    Kapan Akta Perceraian harus dibuat?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq2">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                    Berapa biaya pembuatan Akta Perceraian?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq3">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                    Apakah kedua pihak harus hadir?
                                </button>
                            </h2>
...
.pelayanan-card:hover {
    box-shadow: 0 8px 32px rgba(244, 67, 54, 0.13);
...
.dark-mode .pelayanan-card {
    box-shadow: 0 8px 32px rgba(244, 67, 54, 0.10);
}
