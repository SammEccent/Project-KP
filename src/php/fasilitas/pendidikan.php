        ...
        <section class="facility-section">
            <div class="container">
                ...
                <div class="facility-grid">
                    <?php
                    $query = "SELECT * FROM fasilitas_pendidikan WHERE status = 'aktif' ORDER BY nama_fasilitas ASC";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <div class="facility-card">
                                <img src="<?php echo $base_url; ?>assets/images/fasilitas/pendidikan/<?php echo strtolower(str_replace(' ', '-', $row['nama_fasilitas'])); ?>.jpg" 
                                ...
                                <div class="facility-info">
                                    ...
                                    <p><i class="fas fa-school"></i> <?php echo htmlspecialchars($row['jenis_fasilitas']); ?></p>
                        ...
                        echo '<p class="no-data">Belum ada data fasilitas pendidikan yang tersedia.</p>';
                    }
                    ?>
                </div>
            </div>
